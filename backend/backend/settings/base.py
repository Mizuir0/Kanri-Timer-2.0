...
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgresql://kanritimer_user:kanritimer_password@db:5432/kanritimer'),
        conn_max_age=600
    )
}
